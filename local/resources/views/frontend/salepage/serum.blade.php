...
@section('title')
Smartsolar Smooth&Bright up Serum
@endsection
@section('meta')
<meta property="og:title" content="Smartsolar Smooth&Bright up Serum">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <img src="{{ asset('frontend/salepage/serum/1.png') }}"
                class="img-fluid" alt="Smartsolar Smooth&Bright up serum">
        </div>
