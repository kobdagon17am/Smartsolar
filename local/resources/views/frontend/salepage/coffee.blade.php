...
@section('title')
Smartsolar herbal coffee
@endsection
@section('meta')
<meta property="og:title" content="Smartsolar herbal coffee">
<meta property="og:image" content="{{ asset('frontend/salepage/coffee/0.jpg') }}">
<meta property="og:description" content="Smartsolar herbal coffee">
@endsection
@section('css')
    ...
    <div class="container">
        <div class="row justify-content-center pt-3">
            <img src="{{ asset('frontend/salepage/coffee/1.png') }}"
                class="img-fluid" alt="Smartsolar herbal coffee<">
        </div>
