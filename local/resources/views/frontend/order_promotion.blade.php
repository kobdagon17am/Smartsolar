                ...
                <div class="col-md-12">
                    <div class="card card-box borderR10 mb-2 mb-md-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4 class="card-title mb-0"> Promotion </h4>
                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                          ...
                                          <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="tab-pane fade" id="one-tab-pane" role="tabpanel" aria-labelledby="one-tab" tabindex="0">
                                                <?php
                                                $one = \App\Http\Controllers\Frontend\OrderController::product_list('promotion',2);
                                            ...
                                            <div class="tab-pane fade" id="set-tab-pane" role="tabpanel" aria-labelledby="set-tab" tabindex="0">
                                                <?php
                                                $one = \App\Http\Controllers\Frontend\OrderController::product_list('promotion',3);
                                            ...
                                            <div class="tab-pane fade" id="promotion-tab-pane" role="tabpanel" aria-labelledby="promotion-tab" tabindex="0">
                                                <?php
                                                $one = \App\Http\Controllers\Frontend\OrderController::product_list('promotion',8);
