...
Route::get('admin/Blank', function () {
  ...
  Route::post('admin/register','Admin\MemberRigisterController@register')->name('admin/register');
  ...
  Route::get('admin/bill/list', 'Admin\BillController@index')->name('admin/bill/list');
  Route::get('admin/bill/create', 'Admin\BillController@create')->name('admin/bill/create');

  Route::get('admin/bill/bill_create_datatable', 'Admin\BillController@bill_create_datatable')->name('admin/bill/bill_create_datatable');
  Route::post('admin/bill/modal_bill_create', 'Admin\BillController@modal_bill_create')->name('admin/bill/modal_bill_create');
